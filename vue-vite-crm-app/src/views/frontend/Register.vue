    ...
    <div
      ...
      <div class="flex flex-col overflow-y-auto md:flex-row">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
          <div class="w-full">
            <h1 class="mb-4 text-xl font-semibold dark:text-gray-200">
              สมัครสมาชิกใหม่
            </h1>
            ...
            <form>
              ...
              <label class="block mt-3 mb-2 text-sm" for="username"
                >ชื่อผู้ใช้</label
              >
              <input
                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none"
              ...
              <label class="block mt-3 mb-2 text-sm" for="mobile"
                >เบอร์โทรศัพท์</label
              >
              <input
                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none"
              ...
              <label class="block mt-3 mb-2 text-sm" for="password"
                >รหัสผ่าน</label
              >
              <input
                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none"
              ...
              <label class="block mt-3 mb-2 text-sm" for="confirm_password"
              ...
              <label class="flex items-center dark:text-gray-400">
                ...
                <span class="ml-2"
                  >ฉันยอมรับ
                  <span class="underline">เงื่อนไขการใช้งานระบบ</span>
                </span>
              </label>
            ...
            <p class="mt-2">
              <a
                ...
                >ฉันเป็นสมาชิกอยู่แล้ว ? เข้าสู่ระบบ</a
              >
            </p>
          </div>
        </div>
