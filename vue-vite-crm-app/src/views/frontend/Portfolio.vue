      ...
      <div class="flex flex-wrap items-center mb-4">
        <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
          <a href="#" class="block text-left hover:opacity-75">
            <img
              src="@/assets/img/img-work-1.webp"
              class="object-cover w-full h-64" />
            <div
              class="flex items-center justify-between px-4 py-3 bg-indigo-100">
        ...
        <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
          <a href="#" class="block text-left hover:opacity-75">
            <img
              src="@/assets/img/img-work-2.webp"
              class="object-cover w-full h-64" />
            <div
              class="flex items-center justify-between px-4 py-3 bg-indigo-100">
        ...
        <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
          <a href="#" class="block text-left hover:opacity-75">
            <img
              src="@/assets/img/img-work-3.webp"
              class="object-cover w-full h-64" />
            <div
              class="flex items-center justify-between px-4 py-3 bg-indigo-100">
        ...
        <div class="w-full p-4 lg:w-3/12 sm:w-6/12">
          <a href="#" class="block text-left hover:opacity-75">
            <img
              src="@/assets/img/img-work-4.webp"
              class="object-cover w-full h-64" />
            <div
              class="flex items-center justify-between px-4 py-3 bg-indigo-100">
